...
class FossilDownloadStrategy < AbstractDownloadStrategy
  ...
  def stage
    # TODO: The 'open' and 'checkout' commands of Fossil are very noisy and have no '-q' option.
    # I think the best solution is to work on Fossil itself and add '-q' to it.
