...
GITHUB_API_TOKEN_FILE = File.join(ENV['HOME'], '.config', 'homebrew')

HOMEBREW_GITHUB_API_TOKEN = ENV["HOMEBREW_GITHUB_API_TOKEN"] || (File.read(GITHUB_API_TOKEN_FILE) if File.exists?(GITHUB_API_TOKEN_FILE))
