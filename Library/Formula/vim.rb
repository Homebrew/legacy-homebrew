...
class Vim <Formula
  ...
  def install
    options = %w(--with-features=big --disable-gpm --enable-acl --without-x --disable-gui --disable-nls --enable-multibyte --enable-cscope --enable-perlinterp --with-tlib=ncurses)
    Dir.chdir('src') do
