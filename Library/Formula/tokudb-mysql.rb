...
class TokuDBMysql < Formula
  homepage 'http://www.tokutek.com/'
  url 'https://github.com/Tokutek/mysql/archive/tokudb-7.0.1.tar.gz'
  version '7.0.1'
  sha1 'd91ccf549e6e368e0645763aceffbf1bafd1bd35'
...
#  end
  ...
  conflicts_with 'mariadb',
    :because => "mysql-tokudb and mariadb install the same binaries."

  conflicts_with 'tokudb-mariadb',
    :because => "mysql-tokudb and tokudb-mariadb install the same binaries."

  conflicts_with 'percona-server',
    :because => "mysql-tokudb and percona-server install the same binaries."

  conflicts_with 'mysql-cluster',
    :because => "mysql-tokudb and mysql-cluster install the same binaries."
