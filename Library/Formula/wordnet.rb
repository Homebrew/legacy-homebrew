...
class Wordnet < Formula
  ...
  def install
    ...
    #During compilation code calls deprecated fields within Tcl_Interp, solution
    #found here: (https://bugzilla.redhat.com/show_bug.cgi?id=902561) is to remove
    #the use of those fields with a compiler flag
