class Libgweather < Formula
  ...
  def install
    ...
    inreplace "libgweather/Makefile.in", "@HAVE_INTROSPECTION_TRUE@girdir = $(INTROSPECTION_GIRDIR)",
      "@HAVE_INTROSPECTION_TRUE@girdir = $(datadir)/gir-1.0"
    inreplace "libgweather/Makefile.in", "@HAVE_INTROSPECTION_TRUE@typelibdir = $(INTROSPECTION_TYPELIBDIR)",
