...
class GitManuals < Formula
  url 'http://kernel.org/pub/software/scm/git/git-manpages-1.7.4.5.tar.bz2'
  md5 'b37942bdcff70b4fae4184cd5da5db2e'
end

class GitHtmldocs < Formula
  url 'http://kernel.org/pub/software/scm/git/git-htmldocs-1.7.4.5.tar.bz2'
  md5 '60f8acfbc7a3fd4808e031ad2d2d4c2b'
end

class Git < Formula
  url 'http://kernel.org/pub/software/scm/git/git-1.7.4.5.tar.bz2'
  md5 '2fa6c4c847ed87523cf55de54af457eb'
