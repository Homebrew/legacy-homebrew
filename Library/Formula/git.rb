...
class Git < Formula
  ...
  def install
    ...
    # Fix issue #333: https://github.com/mxcl/homebrew/issues/333
    # Unset PERL_MM_OPT. Else, those who use local::lib get error:
    ...
    inreplace "Makefile" do |s|
      s.remove_make_var! %w{CFLAGS LDFLAGS} # set by Homebrew in ENV.rb
    end
    ...
    # I'm assuming this is an overisght by the git devs.
    git_md5 = (bin+'git').md5
    ...
    # Download prebuilt manpages. Much faster & easier than building ourselves.
  ...
  def caveats; <<-EOS.undent
    ...
    For bash completion, add the following lines to your ~/.bash_profile file:

    # Enable Bash tab-completion of Git commands, branch & file names, etc.
