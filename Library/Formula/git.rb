...
class GitManuals < Formula
  ...
  mirror 'http://ltsp.mirrors.tds.net/pub/kernel.org/software/scm/git/git-manpages-1.7.6.1.tar.bz2'
  md5 'cae559424a62507cb2c15252d85a158e'
end

class GitHtmldocs < Formula
  url 'http://kernel.org/pub/software/scm/git/git-htmldocs-1.7.6.1.tar.bz2'
  mirror 'http://ltsp.mirrors.tds.net/pub/kernel.org/software/scm/git/git-htmldocs-1.7.6.1.tar.bz2'
  md5 'f698e0abbf1555582e30320930391c59'
end

class Git < Formula
  url 'http://kernel.org/pub/software/scm/git/git-1.7.6.1.tar.bz2'
  mirror 'http://ltsp.mirrors.tds.net/pub/kernel.org/software/scm/git/git-1.7.6.1.tar.bz2'
