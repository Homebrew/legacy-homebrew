...
class Qt5 < Formula
  ...
  def install
    ...
    system "install_name_tool", "-change", "#{pwd}/qt-everywhere-opensource-src-5.1.1/qtwebkit/lib/QtWebKitWidgets.framework/Versions/5/QtWebKitWidgets", #old
                                           "#{lib}/QtWebKitWidgets.framework/Versions/5/QtWebKitWidgets",  #new
                                           "#{libexec}/QtWebProcess" # in this lib
    system "install_name_tool", "-change", "#{pwd}/qt-everywhere-opensource-src-5.1.1/qtwebkit/lib/QtWebKit.framework/Versions/5/QtWebKit",
