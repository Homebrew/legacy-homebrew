...
class Samtools < Formula
  ...
  def install
    ...
    bin.install %w{samtools razip bcftools/bcftools bcftools/vcfutils.pl misc/maq2sam-long misc/maq2sam-short misc/md5fa misc/md5sum-lite misc/seqtk misc/wgsim}
