...
class Udns < Formula
  ...
  def install
    ...
    system "make dylib"
    bin.install "dnsget"
    bin.install "rblcheck"
    doc.install "NOTES"
    doc.install "TODO"
    doc.install "ex-rdns.c"
    include.install "udns.h"
    lib.install "libudns.a"
    lib.install "libudns.0.dylib"
    lib.install "libudns.dylib"
    man1.install "dnsget.1"
    man1.install "rblcheck.1"
    man3.install "udns.3"
  end
end
