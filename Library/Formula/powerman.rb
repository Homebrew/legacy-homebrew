...
class Powerman < Formula
  ...
  option "with-genders", "Builds with genders"
  option "with-ncurses", "Builds with ncurses"
  ...
  def install
    ...
    args << (build.with?("ncurses") ? "--with-ncurses" : "--without-ncurses")
