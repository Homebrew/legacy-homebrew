...
class Glide < Formula
  ...
  url "https://github.com/Masterminds/glide/archive/0.6.0.tar.gz"
  sha256 "385ae32c1feb451dda358e6f20459e0fb6ce14c19ca669a12305d8ccd80c4899"
  ...
  def install
    ...
    system "go", "build", "-o", "glide", "-ldflags", "-X main.version 0.6.0", "#{buildpath}/src/github.com/Masterminds/glide/glide.go"
    bin.install "glide"
  end

  test do
    version = pipe_output("#{bin}/glide --version")
    assert_match /0.6.0/, version
  end
end
