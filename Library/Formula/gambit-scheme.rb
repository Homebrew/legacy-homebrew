...
class GambitScheme < Formula
  ...
  url 'http://www.iro.umontreal.ca/~gambit/download/gambit/v4.7/source/gambc-v4_7_0-devel.tgz'
  sha1 '1057e07c222d50634dc5dfb50487c0c3d3941050'
    ...
    unless ENV.compiler == :gcc
      opoo <<-EOS.undent
        ...
        You can remedy this by installing an apple-gcc* or gcc* package.
            ...
            brew install gcc48
            brew install --cc=gcc-4.8 gambit-scheme
