...
class Gkrellm < Formula
  ...
  def install
    ENV.prepend_path 'PATH', Formula.factory('gettext').bin

    inreplace 'Makefile', '$(PREFIX)', prefix
    inreplace 'src/gkrellm.h', '/usr/local/share/gkrellm2/themes', "#{share}/gkrellm2/themes"
    inreplace 'src/gkrellm.h', '/usr/share/gkrellm2/themes', "#{share}/gkrellm2/themes"
    inreplace 'src/gkrellm.h', '/usr/local/lib/gkrellm2/plugins', "#{libexec}/gkrellm2/plugins"
    inreplace 'src/gkrellm.h', '/usr/lib/gkrellm2/plugins', "#{libexec}/gkrellm2/plugins"
