...
class IrcdHybrid < Formula
  ...
  # This is empty on install, and homebrew strips it, but it needs to be around or you get no log file
  skip_clean 'var/log'
  # Don't strip this if empty too
  skip_clean 'var/run'
  # We don't want to strip the .la files
  skip_clean 'lib'
  ...
  # Fix 4: TODO make logging to HOMEBREW_PREFIX/var/log/ircd/ircd.log work, it currently only logs
  # to KEG_PATH/var/log/ircd.log, with no config option, needs some hacking
  def patches
    DATA
  end
