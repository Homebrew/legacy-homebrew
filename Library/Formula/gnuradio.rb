class Gnuradio < Formula
  ...
  def install
    ...
    enabled_components += %w[python gr-ctrlport grc gr-utils
                             gr-qtgui gr-wxgui] if build.with? "python"
    ...
    delete_files = %w[ctrlport-monitorc ctrlport-monitoro
                      perf-monitorxc perf-monitorxo]
