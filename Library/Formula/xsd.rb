class Xsd < Formula
  ...
  def caveats; <<-EOS.undent
    Note that this formula has been compiled with clang++ against libc++ because
    xerces-c uses libc++ too. Apparently, this configuration is not well tested
    and you might encounter some issues, see:
    http://www.codesynthesis.com/pipermail/xsd-users/2015-February/004522.html
    EOS
  end
