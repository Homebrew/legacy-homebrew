...
class Pypy3 < Formula
  ...
  bottle do
    cellar :any
    revision 5
    sha1 "5913e695ae9324959515fa1308764d52155d2a64" => :yosemite
    sha1 "f71603e7c10af67fd5c756c821e9985416eec4da" => :mavericks
    sha1 "e9bf22ef9f4ab158ffce6ddc6f51728ced7cfaac" => :mountain_lion
  end
  ...
  resource "setuptools" do
    url "https://pypi.python.org/packages/source/s/setuptools/setuptools-11.0.tar.gz"
    sha1 "6dcd7f04f946cf572036cf81e4d9594a28f66c06"
  end
