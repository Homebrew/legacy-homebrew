...
class Winetricks < ScriptFileFormula
  ...
  url 'https://winetricks.googlecode.com/svn-history/r1217/trunk/src/winetricks', :using => :curl
  ...
  head 'https://winetricks.googlecode.com/svn/trunk/src/winetricks', :using => :curl
