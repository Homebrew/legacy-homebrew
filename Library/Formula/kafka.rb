class Kafka < Formula
  ...
  def install
    ...
    rm_f "core/build/dependant-libs-2.10.4/slf4j-log4j12-1.7.6.jar"
  ...
  test do
    ...
    # Thus, a correct java.class.path implies that the correct version of Kafka has been installed and the
    # fact that it runs to begin with indicates that the prerequisites for successful environment to run in are met.
    #
