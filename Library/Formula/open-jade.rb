...
class OpenJade < Formula
  ...
  def patches
    ...
    { :p0 => %W[
      ...
      https://trac.macports.org/export/112943/trunk/dports/textproc/openjade/files/openjade-getoptperl.patch ] +
    # Patch for building with clang compiler
      %W[ https://gist.github.com/theirix/3732794/raw/7d0c7d269bbf9d93b394b52e68810615d9aa33cb/default-ctor.patch ] +
    # Patch for correct handling libtool library
      %W[ https://gist.github.com/theirix/3732807/raw/1400a70e6396f2c2f3d90a0ca1035e7a79ae8bd6/Makefile.prog.in.patch ]
      }
  end
