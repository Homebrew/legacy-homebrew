...
class Mutt < Formula
  ...
  def patches
    ...
    # Description of the trash patch at
    # http://patch-tracker.debian.org/patch/series/view/mutt/1.5.21-3/features/trash-folder
    if ARGV.include? '--trash-patch'
      p << 'http://patch-tracker.debian.org/patch/series/dl/mutt/1.5.21-3/features/trash-folder'
    end
