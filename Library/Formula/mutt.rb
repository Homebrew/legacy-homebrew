...
class Mutt < Formula
  ...
  def options
    [
      ...
      ['--trash-patch', "Apply trash folder patch (enables purge patch as well)"],
  ...
  def patches
    urls = [
      ...
      ['--trash-patch', 'http://www.cs.oberlin.edu/~kuperman/help/code/patch-1.5.20.bk.trash_folder-purge_message.1.txt'],
