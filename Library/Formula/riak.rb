...
class Riak < Formula
  ...
  if Hardware.is_64_bit? and not build.build_32_bit?
    url 'http://downloads.basho.com.s3-website-us-east-1.amazonaws.com/riak/CURRENT/osx/10.4/riak-1.2.1-osx-x86_64.tar.gz'
    version '1.2.1-x86_64'
    sha256 'aa7a99c8cd280a1529b97d690a1faaa0fb05211a87b077cf4f19cb0921cb492b'
  else
    url 'http://downloads.basho.com.s3-website-us-east-1.amazonaws.com/riak/CURRENT/osx/10.4/riak-1.2.1-osx-i386.tar.gz'
    version '1.2.1-i386'
