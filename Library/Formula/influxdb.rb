...
class Influxdb < Formula
  ...
  devel do
    url "https://github.com/influxdb/influxdb/archive/v0.9.0-rc4.tar.gz"
    sha1 "b4812d4d61fc4199a8aba10750a404f40bb335ad"
    version "0.9.0-rc4"
  end
  ...
  def install
    if build.stable?
      ...
      cd influxdb_path do
        system "go", "build", "-ldflags", "-X main.version 0.9.0-rc4 -X main.commit 048c6fcde6834b20ef2d74bd2d28b2f822418da9", "./..."
        system "go", "install", "./..."
      end
