...
class MysqlPercona < Formula
  homepage 'http://www.percona.com'
  url 'http://www.percona.com/redir/downloads/Percona-Server-5.5/Percona-Server-5.5.12-20.3/source/Percona-Server-5.5.12-rel20.3.tar.gz'
  md5 '6e4a48a5d2f291fbb72fac9a609d0e14'
