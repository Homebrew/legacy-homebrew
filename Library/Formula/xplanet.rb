...
class Xplanet < Formula
  ...
  depends_on "pango" if build.with? "pango" or build.with? "all"
  depends_on "netpbm" if build.with? "netpbm" or build.with? "all"
  depends_on "cspice" if build.with? "pango" or build.with? "all"
