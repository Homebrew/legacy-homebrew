...
class Inkscape < Formula
  ...
  def caveats; <<-EOS.undent
    From http://wiki.inkscape.org/wiki/index.php/FAQ#Copying_and_pasting_in_Inkscape_creates_pixellated_images_instead_of_copying_the_vector_objects

    Copying and pasting in Inkscape creates pixellated images instead
    of copying the vector objects
