...
class Rabbitmq < Formula
  ...
  def install
    ...
    inreplace (sbin + 'rabbitmq-defaults'), 'CLEAN_BOOT_FILE="${SYS_PREFIX}', "CLEAN_BOOT_FILE=\"#{prefix}"
    inreplace (sbin + 'rabbitmq-defaults'), 'SASL_BOOT_FILE="${SYS_PREFIX}', "SASL_BOOT_FILE=\"#{prefix}"
