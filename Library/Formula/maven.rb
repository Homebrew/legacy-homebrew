...
class Maven < Formula
  ...
  def patches
    # Fix JAVA_HOME detection using the libexec helper.
    # Now that Java support has changed hands and Java 6 has
    # reached EoL, this should be the preferred way.
    # The patch should be removed once Maven closes MNG-4226.
