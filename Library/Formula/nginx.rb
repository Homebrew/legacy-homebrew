...
class Nginx < Formula
  ...
  option 'with-auth_request', 'Compile with support for auth_request module'
  ...
  def install
    ...
    args << "--with-http_auth_request_module" if build.include?('with-auth_request') && build.devel?
