...
class Trafficserver < Formula
  ...
  url 'http://www.apache.org/dyn/closer.cgi?path=trafficserver/trafficserver-4.0.1.tar.bz2'
  mirror 'http://archive.apache.org/dist/trafficserver/trafficserver-4.0.1.tar.bz2'
