...
class Scantailor < Formula
  ...
  url 'https://downloads.sourceforge.net/project/scantailor/scantailor/0.9.11/scantailor-0.9.11.tar.gz'
  version '0.9.11' => Version
  sha1 '21ec03317ca2b278179693237eaecd962ee0263b'

  devel do
    url 'https://downloads.sourceforge.net/project/scantailor/scantailor-devel/enhanced/scantailor-enhanced-20120812.tar.bz2'
