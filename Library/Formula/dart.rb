...
class Dart < Formula
  ...
  if MacOS.prefer_64_bit?
    url 'https://gsdview.appspot.com/dart-editor-archive-integration/latest/dartsdk-macos-64.zip'
    sha1 'b6f4902cbc48e59799980b2830108ccb2fe8d2b7'
  else
    url 'https://gsdview.appspot.com/dart-editor-archive-integration/latest/dartsdk-macos-32.zip'
