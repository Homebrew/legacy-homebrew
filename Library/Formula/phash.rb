...
class Phash <Formula
  ...
  depends_on 'libsndfile' unless ARGV.include? "--disable-audio-hash"
  depends_on 'libsamplerate' unless ARGV.include? "--disable-audio-hash"
  depends_on 'mpg123' unless ARGV.include? "--disable-audio-hash"
