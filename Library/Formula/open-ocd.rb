...
class OpenOcd < Formula
  url 'git://openocd.git.sourceforge.net/gitroot/openocd/openocd',
          :ref => 'c7a17b8466d655f024d62fd106701e5042fb7ccc'
  homepage 'http://openocd.berlios.de/web/'
  version '0.5'

  depends_on 'libusb-compat'
  depends_on 'libftdi' if ARGV.include?('--enable-ft2232_libftdi') || ARGV.include?('--enable-presto_libftdi')
  ...
  def install
    ...
    # Fails in ./bootstrap without git init with "fatal: Not a git repository..."
    system 'git init'
    system './bootstrap'
