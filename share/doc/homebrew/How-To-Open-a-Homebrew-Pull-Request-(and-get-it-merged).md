...
2. Fork the Homebrew repository on GitHub by clicking [here](https://github.com/Homebrew/homebrew/fork). This creates a pushable, personal remote repository. This is needed as only Homebrew maintainers have push access to the main repository.
